                ...
                <div class="form-box p-5">
                    ...
                    <form class="row g-3" method="POST" action="">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control form-control-lg" name="Inputname" id="Inputname"
                                required>
                        </div>
                        <div class="col-md-6">
                            <label for="InputTlp" class="form-label">No Handphone</label>
                            <input type="text" class="form-control form-control-lg" name="InputTlp" id="InputTlp"
                                required>
                        </div>
                        <div class="col-12">
                            <label for="InputUsername" class="form-label">Username atau Email</label>
                            <input type="text" class="form-control form-control-lg" name="InputUsername"
                                id="InputUsername" required>
                        </div>
                        <div class="col-12">
                            <label for="InputAlamat" class="form-label">Alamat</label>
                            <input type="text" class="form-control form-control-lg" name="InputAlamat" id="InputAlamat"
                                required>
                        </div>
                        <div class="col-12">
                            <label for="inputPassword" class="form-label">Password</label>
                            <input type="password" class="form-control form-control-lg" name="InputPassword"
                        ...
                        <div class="d-grid gap-2">
                            <button class="btn btn-lg btn-custom text-white" style="background-color: #9D4689;"
