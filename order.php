            ...
            <form class=" g-3" method="POST" action="./order/make_order.php">
              <div class="row mb-3">
                ...
                <div class="col-md-4">
                  ...
                  <input type="date" required class="form-control" name="tanggal" value="<?= date("d/m/Y") ?>">
                </div>
              </div>
                  ...
                  <div class="input-wrapper w-full flex justify-between">
                    ...
                    <div class="col-md-4 pr-[5px]">
                      ...
                      <div class="form-floating mb-3">
                        <input type="number" class="form-control" id="inputPanjang" name="inputPanjang"
                    ...
                    <div class="col-md-4 pl-[5px]">
                      ...
                      <div class="form-floating mb-3">
                        <input type="number" class="form-control" id="inputTinggi" name="inputTinggi"
