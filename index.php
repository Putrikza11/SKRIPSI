  ...
  <main class="mt-16">
    ...
    <div class="container-fluid banner p-0">
      <div class="image-wrapper relative banner overflow-hidden	">
        <img src="./asset/img/alfabel.jpeg" alt="usni_image_hero" class="w-full  object-cover object-bottom h-100 "
          loading='lazy'>
        ...
        <div class="bg-gradient-custom  search-bar-wrapper  h-full w-full flex flex-wrap flex-col justify-center p-0">
          <div class="col-md-6 my-auto container tagline">
            ...
            <a href="registrasi.html" class="btn text-white bg-gradient-to-tr from-[#A25E91] to-[#D26ECF]" role="button"
              data-bs-toggle="button">DAFTAR SEKARANG</a>
            <?php endif; ?>
      ...
      <div class="mx-4 p-4">
        <div class="flex items-center">
          <div class="flex items-center text-fuchsia-700 relative">
            <div
              class="rounded-full transition duration-500 ease-in-out hover:border-fuchsia-500 h-20 w-20 py-3 border-2 border-fuchsia-700">
              <i class="fa-solid fa-file-lines block mx-auto w-fit text-4xl"></i>
            </div>
            <div
              class="absolute top-0 -ml-6 text-center mt-[5.5rem] w-32 text-sm font-medium uppercase text-fuchsia-700">
              1. Mengisi form sesuai pesanan</div>
          </div>

          <div
            class="flex-auto border-t-2 transition duration-500 ease-in-out hover:border-fuchsia-500 border-fuchsia-700">
          </div>
        ...
        <div class="col text-center">
          <a href="order.php">
            <button class="btn btn-CTA btn-light fs-4 border border-2 bg-white
                         border-secondary text-slate-800" style="border-radius: 20px; font-weight: bold;"
              type="submit">Cek Harga</button>
          </a>
        </div>
      </div>
    </div>
